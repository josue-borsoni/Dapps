                        ...
                        dispute.winner == 0 || dispute.winner == 1
                            ? <div className="col">
                                ...
                                <img src={dispute.image1} className="d-block mx-auto img-fluid rounded" width={250} />
                                {
                                    ...
                                    : <button onClick={() => processBet(1)} className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }}>Aposto nesse candidato</button>
                                }
                        ...
                        dispute.winner == 0 || dispute.winner == 2
                            ? <div className="col">
...

                                {
                                    dispute.winner == 2
                                    ? <button onClick={btnClaimClick} className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }}>Pegar meu prêmio</button>
                                    : <button onClick={() => processBet(2)} className="btn btn-primary p-3 my-2 d-block mx-auto" style={{ width: 250 }}>Aposto nesse candidato</button>
                                }
